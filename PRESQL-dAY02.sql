...
CREATE TABLE urunler(  ---bunu aşagıdaki kod deneyelim diye çalıştırdıktan sonra sildik
...
--foreign key eklemenin diger yolu
...
INSERT INTO calisanlar VALUES('', 'osman', 2000, '2018-04-14');-- boş deger null degildir çalışır
...
-- DML -- DELETE KOMUTU
DELETE FROM calisanlar;-- parent oldugundan dolayı ilk önce child olan adresleri silmemiz lazım
DELETE FROM adresler;--sadece datalari siler table yapısı kalir.
DROP TABLE adresler;-- kalıcı siler hepsi gider

SELECT * FROM adresler;

--Adresler tablosundan sehri Antep olan verileri silelim

DELETE FROM adresler WHERE sehir='Antep';-- o satırdaki herşeyi siler antepi bulur o satırdaki her şeyi siler
