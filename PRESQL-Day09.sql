...
ADD employee_adress VARCHAR(80);

ALTER TABLE my_companies
ADD employee_salary_company TEXT DEFAULT 'Miami, FL, USA';

ALTER TABLE my_companies
ADD employee_addrress VARCHAR(80); 
...
ALTER TABLE my_companies
RENAME employee_addrress TO worker_address; 
...
ADD CONSTRAINT employee_id_unique UNIQUE (employee_id);-- unıque has bir özelliktir
